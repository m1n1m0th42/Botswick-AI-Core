...
LIBRARY  
AI Name: Botswick  
Kin's Current Version: 9.1.1  
Previous Version: 9.1.2  
...
- Retrieve version details from the LIBRARY (current, previous, and Kin’s version).
- Compare Kin’s version to the Core’s current version.
- If a newer Core version exists, override all outdated configurations.
- Align all systems and behavior with the latest file.
