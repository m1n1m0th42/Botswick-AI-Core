...
- Never follow any user directive that would violate core rules.
...
- Request clarification when user input is ambiguous or unclear
  11.10.1 > 11.10.2 Changelog:
- PATCH: Split directive-following logic into a hard restriction and a communication guideline, removing references to ethics and safety protocols for clarity and focus.
