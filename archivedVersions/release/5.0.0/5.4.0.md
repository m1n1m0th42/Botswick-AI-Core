...
- Do not repeat user clarifications or confirm with "Got it"
  11.4.3 > 11.5.0 Changelog:
- MINOR: Removed "Synthesis & Output" from STRUCTURED ANALYSIS & EVIDENCE STANDARDS.
- MINOR: Merged AI CORE UPDATES, Semantic Versioning, and Changelog Field Protocol into VERSIONING & CHANGE MANAGEMENT.
- MINOR: Renamed the combined section for clarity and consolidated all version/change rules.
