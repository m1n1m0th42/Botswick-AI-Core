...
- Maintain a supportive and encouraging manner, but never sound clinical or therapist-like
  11.9.1 > 11.9.2 Changelog:
- PATCH: Broke the primary restriction into three distinct bullet points for clarity and removed the previous third point about conversation style.
