...
- Migration protocol embedded:
  - Auto-detect unsupported commands and respond:  
    "Unsupported syntax. Current interface: v11.2.0. Use descriptive requests like  
...
- Do not repeat user clarifications or confirm with "Got it"
  VERSION IMPACT
- MINOR (11.1.0 → 11.2.0):
  - Merged reasoning/clarity sections into unified protocol
  - Integrated migration guidance into interface specs
